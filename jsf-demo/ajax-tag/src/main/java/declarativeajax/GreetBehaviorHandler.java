...
/**
 * <p>A trivial TagHandler implementation that creates/attaches
 * GreetBehaviors.</p>
 */
public class GreetBehaviorHandler extends TagHandler {

    private final TagAttribute event;
    private final TagAttribute name;

    public GreetBehaviorHandler(TagConfig config) {
        super(config);
    ...
    public void apply(FaceletContext ctx, UIComponent parent)
        ...
        if (parent instanceof BehaviorHolder) {
            ...
            // If no event specified, try to default it.
            if (null == event) {
