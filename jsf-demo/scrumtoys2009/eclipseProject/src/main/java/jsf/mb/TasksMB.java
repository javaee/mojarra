...
public class TasksMB extends AppMB {
	...
	public String edit() {
		...
		getFacesUtil().addGlobalInfoMessage("Edite a tarefa selecionada.", String.format("Edite a tarefa %s. Clique no bot�o %s para terminar.", this.taskToSave.getName(),"save"));
		return OUTCOME.SAME_PAGE.getValue();
	}
