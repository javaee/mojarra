    ...
    protected void setProperties(UIComponent component) {
        ...
        if (border != null) {
            if (!border.isLiteralText()) {
                ...
                panel.getAttributes().put("border", java.lang.Integer.valueOf(border.getExpressionString()));
            }
        }
        ...
        if (columns != null) {
            if (!columns.isLiteralText()) {
                ...
                panel.getAttributes().put("columns", java.lang.Integer.valueOf(columns.getExpressionString()));
            }
        }
        if (onclick != null) {
