...
<%
    ...
    try {
        ...
        out.println("/methodref02.jsp FAILED - setExtraProperty() exception: "
                    + e);
    ...
    try {
        ...
        if (!params[0].equals(result)) {
            out.println(
                  "/methodref02.jsp FAILED - getExtraProperty() returned: "
                  + result);
            return;
        }
    } catch (Exception e) {
        out.println("/methodref02.jsp FAILED - getExtraProperty() exception: "
                    + e);
        e.printStackTrace(System.out);
        return;
    }
    ...
    try {
        ...
        out.println("/methodref02.jsp FAILED - setStringProperty() exception: "
                    + e);
        e.printStackTrace(System.out);
        return;
    }
    try {
        ...
        if (!params[0].equals(result)) {
            out.println(
                  "/methodref02.jsp FAILED - getStringProperty() returned: "
                  + result);
            return;
        }
    } catch (Exception e) {
        out.println("/methodref02.jsp FAILED - getStringProperty() exception: "
                    + e);
        e.printStackTrace(System.out);
        return;
    }
