...
<%-- $Id: command_button_test.jsp,v 1.12 2006/03/29 22:39:13 rlubke Exp $ --%>
<html>
<head>
...
<f:view locale="en_US">
    <h:form id="form01">
        ...
        <h:command_button id="button02" type="reset"
                          value="#{test1.stringProperty}"/>
        <h:command_button id="button03" type="submit"
                          value="#{messageBundle.button_key}"/>
        <h:command_button id="button04" type="reset" image="duke.gif"
                          value="FAIL"/>
        <h:command_button id="button05" type="submit"
