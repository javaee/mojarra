...
<% ArrayList list = new ArrayList();
    ...
    inputWithIdList.add("inputid1");
    inputWithIdList.add("inputid2");
    inputWithIdList.add("inputid3");
    pageContext.setAttribute("inputWithIdList",
                             inputWithIdList,
    ...
    <h:form id="myform">
        ...
        <c:forEach var="item" items="#{input}">
            <h:inputText value="#{item}"
                         valueChangeListener="#{forEachBean1.valueChange1}"/>
            <br>
        </c:forEach>
        ...
        <c:forEach var="itemWithId" items="#{inputWithIdList}">
            <h:inputText id="inputId1" value="#{itemWithId}"
                         valueChangeListener="#{forEachBean1.valueChange2}"/>
            <br>
        </c:forEach>
