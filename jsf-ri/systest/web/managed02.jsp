...
<%
    ...
    ValueExpression valueExpression = appl.getExpressionFactory()
          .createValueExpression(facesContext.getELContext(), "#{test2}",
                                 Object.class);
    ...
    if (!(result instanceof TestBean)) {
        out.println("/managed02.jsp FAILED - result of type " + result
              .getClass());
        return;
    }
    ...
    if (errors.length() < 1) {
        ...
        out.println("/managed02.jsp FAILED - property value errors:  "
                    + errors);
    }
%>2
