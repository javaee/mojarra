/*
 * $Id: ManagedBeanLifecycleAnnotationTestCase.java,v 1.6.4.1 2010/05/21 17:55:33 edburns Exp $
 */
...
public class ManagedBeanLifecycleAnnotationTestCase extends AbstractTestCase {
    ...
    public void testNoneScopeBean() throws Exception {
        String text = null;
        HtmlPage page = getPage("/faces/noneScopeBean.jsp");
        text = page.asText();
        assertTrue(text.matches(".*There should be no text between these brackets \\[\\s*\\]\\..*"));
    }
