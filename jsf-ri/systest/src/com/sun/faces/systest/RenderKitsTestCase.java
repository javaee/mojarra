/*
 * $Id: RenderKitsTestCase.java,v 1.3 2006/03/29 22:38:50 rlubke Exp $
 */
...
public class RenderKitsTestCase extends AbstractTestCase {
    ...
    public void testDefaultRenderKitId() throws Exception {
        ...
        try {
            hidden = (HtmlHiddenInput) form
                  .getInputByName("javax.faces.RenderKitId");
        } catch (ElementNotFoundException e) {
            exceptionThrown = true;
        }
        assertTrue(-1 != page.asText().indexOf("CUSTOM"));
        assertTrue(-1 != page.asText()
              .indexOf("com.sun.faces.systest.render.CustomResponseWriter"));
        ...
        assertNotNull("form exists", form);
        hidden =
              (HtmlHiddenInput) form.getInputByName("javax.faces.RenderKitId");
        assertNotNull("hidden exists", hidden);
        assertTrue(-1 != page.asText().indexOf("HTML_BASIC"));
        assertTrue(-1 != page.asText()
              .indexOf("com.sun.faces.renderkit.html_basic.HtmlResponseWriter"));
