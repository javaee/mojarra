/*
 * $Id: MethodRefTestCase.java,v 1.10.32.3 2007/04/27 21:27:53 ofung Exp $
 */
...
public class MethodRefTestCase extends AbstractTestCase {
    ...
    public void testActionAndActionListener() throws Exception {
        ...
        page = getPage("/faces/jsp/jsp-dynamic-00.jsp");
		...
		"cl"+ "=form:button2&form=form&com.sun.faces.VIEW=_id2:_id3");
        assertNotNull(page);
        form = getFormById(page, "form");
        input = (HtmlTextInput)
            form.getInputByName("form" + NamingContainer.SEPARATOR_CHAR +
