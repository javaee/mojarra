/*
 * $Id: ValueChangeListenerTestCase.java,v 1.8 2006/03/29 22:38:47 rlubke Exp $
 */
...
public class ValueChangeListenerTestCase extends AbstractTestCase {
    ...
    public void testValueChangeListener() throws Exception {
        ...
        assertTrue(-1 !=
                   page.asText()
                         .indexOf("Received valueChangeEvent for textA"));

        assertTrue(-1 !=
                   page.asText()
                         .indexOf("Received valueChangeEvent for textB"));
