...
public class AjaxViewStateTestCase extends HtmlUnitFacesTestCase {

    public AjaxViewStateTestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return (new TestSuite(AjaxViewStateTestCase.class));
    }
