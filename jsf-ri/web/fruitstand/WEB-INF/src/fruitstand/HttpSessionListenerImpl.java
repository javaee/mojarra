/*
 * $Id: HttpSessionListenerImpl.java,v 1.1 2001/12/02 01:23:38 edburns Exp $
 *
 ...
 *
 * @version $Id: HttpSessionListenerImpl.java,v 1.1 2001/12/02 01:23:38 edburns Exp $
 * 
 * @see	Blah
 * @see	Bloo
 *
...
public void sessionCreated(HttpSessionEvent sce) {
	...
	ot.put(ObjectTable.RequestScope, "userName", TextModel.class);
	ot.put(ObjectTable.RequestScope, "password", TextModel.class);
	**/
	didGlobalInit = true;
    }
}
