/* 
 * $Id: ViewHandlerImpl.java,v 1.69 2006/03/29 22:38:30 rlubke Exp $ 
 */
 ...
 *
 * @version $Id: ViewHandlerImpl.java,v 1.69 2006/03/29 22:38:30 rlubke Exp $
...
public class ViewHandlerImpl extends ViewHandler {
    ...
    public String getActionURL(FacesContext context, String viewId) {
        ...
        if (viewId.charAt(0) != '/') {
            String message = MessageUtils
                  .getExceptionMessageString(MessageUtils.ILLEGAL_VIEW_ID_ID,
                                             new Object[]{viewId});
    ...
    public void renderView(FacesContext context,
        ...
        RenderKit renderKit =
              renderFactory
                    .getRenderKit(context, viewToRender.getRenderKitId());
            ...
            do {
                ...
                if (-1 == (markerIndex =
                    ...
                    context.getResponseWriter()
                          .write(content.substring(beginIndex));
                } else {
    ...
    private void doRenderView(FacesContext context,
        ...
        if (logger.isLoggable(Level.FINE)) {
            logger.log(Level.FINE,
                       "About to render view " + viewToRender.getViewId());
        }
    ...
    private boolean executePageToBuildView(FacesContext context,
        ...
        extContext.setResponse(wrapped =
              new ViewHandlerResponseWrapper((HttpServletResponse) extContext
                    .getResponse()));
