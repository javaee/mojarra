/*
 * $Id: ApplicationImpl.java,v 1.73 2006/03/29 22:38:30 rlubke Exp $
 */
    ...
    public UIComponent createComponent(String componentType)
        ...
        if (returnVal == null) {
            ...
            throw new FacesException(MessageUtils.getExceptionMessageString(
                  MessageUtils.NAMED_OBJECT_NOT_FOUND_ERROR_MESSAGE_ID,
                  params));
        }
    ...
    public Converter createConverter(Class targetClass) {
        ...
        if (interfaces != null) {
            for (int i = 0; i < interfaces.length; i++) {
                returnVal =
                      createConverterBasedOnClass(interfaces[i], targetClass);
                if (returnVal != null) {
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine("Created converter of type " +
                                    returnVal.getClass().getName());
