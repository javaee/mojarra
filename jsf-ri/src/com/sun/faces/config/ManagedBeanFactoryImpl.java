/*
 * $Id: ManagedBeanFactoryImpl.java,v 1.9 2006/03/29 22:38:31 rlubke Exp $
 */
...
public class ManagedBeanFactoryImpl extends ManagedBeanFactory {
    ...
    public ManagedBeanFactoryImpl(ManagedBeanBean managedBean) {
        ...
        this.managedBean =
              managedBean; // (ManagedBeanBean) managedBean.clone();
        //set the scope
    ...
    public void setManagedBeanFactoryMap(
          Map<String, ManagedBeanFactory> newManagedBeanFactoryMap) {
    ...
    private Object evaluateValueExpressionGet(String value)
        ...
        if (ve != null) {
            ...
            throw new FacesException(
                  MessageUtils.getExceptionMessageString(
                        MessageUtils.ERROR_GETTING_VALUE_BINDING_ERROR_MESSAGE_ID,
                        obj));
        }
        return result;
    ...
    private Scope getNarrowestScopeFromExpression(String expression)
    ...
    private Scope getScopeForSingleExpression(String value)
