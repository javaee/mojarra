/*
 * $Id: ViewTag.java,v 1.42 2006/03/29 22:38:42 rlubke Exp $
 */
 ...
 *
 * @version $Id: ViewTag.java,v 1.42 2006/03/29 22:38:42 rlubke Exp $
 */
        ...
        try {
            ...
            if (null != beforePhase) {
                if (beforePhase.isLiteralText()) {
                    ...
                    throw new javax.faces.FacesException(MessageUtils.getExceptionMessageString(
