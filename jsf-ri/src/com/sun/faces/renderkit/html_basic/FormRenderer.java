/*
 * $Id: FormRenderer.java,v 1.78.28.1.2.3 2007/04/27 21:27:44 ofung Exp $
 */
...
public class FormRenderer extends HtmlBasicRenderer {
    ...
    private static void renderClearHiddenParamsJavaScript(ResponseWriter writer,
        Map formParams, String formTarget, String formName) throws IOException {
         ...
         writer.write("\n<!--");
         writer.write("\nfunction ");
         formName = formName.replace(NamingContainer.SEPARATOR_CHAR, '_');
         String functionName = Util.createValidECMAIdentifier(CLEAR_HIDDEN_FIELD_FN_NAME + "_" + formName);
