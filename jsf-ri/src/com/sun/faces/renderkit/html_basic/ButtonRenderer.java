/*
 * $Id: ButtonRenderer.java,v 1.77.28.1.2.3 2007/04/27 21:27:44 ofung Exp $
 */
...
public class ButtonRenderer extends HtmlBasicRenderer {
	...
	String clientId = component.getClientId(context);
        ...
        String functionName = CLEAR_HIDDEN_FIELD_FN_NAME;
        if (formClientId != null) {
            functionName += "_" + 
                    formClientId.replace(NamingContainer.SEPARATOR_CHAR, '_');
        }
        StringBuffer sb = new StringBuffer();
        sb.append(Util.createValidECMAIdentifier(functionName));
