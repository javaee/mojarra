/*
 * $Id: ValueReadOnlyVisitor.java,v 1.2 2004/11/09 04:23:39 jhook Exp $
 */
 ...
 * @author Jacob Hookom
 */
public class ValueReadOnlyVisitor extends AbstractJsfParserVisitor
{
    /**
     * @param context
     * @param ref
     */
    public ValueReadOnlyVisitor(FacesContext context)
    {
        super(context);
    }
    ...
    public Object visit(AstValue node, Object data) throws EvaluationException
    {
        ...
        property = node.jjtGetChild(i).jjtAccept(parent, obj);
        return Boolean.valueOf(this.getPropertyResolver().isReadOnly(obj,
                property));
    }
    ...
    public Object visit(AstVariable node, Object data)
            throws EvaluationException
    {
        // in this case, we can always overwrite non-implicit variables
        return Boolean.valueOf(ELSupport.isImplicitVariable(node.getName()));
    }
}