/*
 * $Id: LifecycleFactoryImpl.java,v 1.28 2006/03/29 22:38:34 rlubke Exp $
 */
 ...
 * in the JSF RI. <P>
 *
 * @version $Id: LifecycleFactoryImpl.java,v 1.28 2006/03/29 22:38:34 rlubke Exp $
...
public class LifecycleFactoryImpl extends LifecycleFactory {
    ...
    public void addLifecycle(String lifecycleId, Lifecycle lifecycle) {
        ...
        if (null != lifecycleMap.get(lifecycleId)) {
            ...
            String message =
                  MessageUtils
                        .getExceptionMessageString(MessageUtils.LIFECYCLE_ID_ALREADY_ADDED_ID,
                                                   params);
