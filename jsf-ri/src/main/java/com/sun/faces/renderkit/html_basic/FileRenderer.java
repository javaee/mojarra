   ...
   // ---------------------------------------------------------- Public Methods
	...
	public void decode(FacesContext context, UIComponent component) {
        ...
        if (newValue != null) {
			...
			HtmlInputFile htmlInputFile = (HtmlInputFile) component;
			Map<String, Object> requestAttributeMap = externalContext.getRequestMap();
			@SuppressWarnings("unchecked")
			Map<String, UploadedFile> facesFileMap =
				(Map<String, UploadedFile>) requestAttributeMap.get("javax.faces.UPLOADED_FILES");
