...
public class ApplicationImpl extends Application {
    ...
    public ApplicationImpl() {
        ...
        componentMap = new ViewMemberInstanceFactoryMetadataMap(new ConcurrentHashMap<String, Object>());
        converterIdMap = new ViewMemberInstanceFactoryMetadataMap(new ConcurrentHashMap<String, Object>());
        converterTypeMap = new ConcurrentHashMap<Class<?>, Object>();
        validatorMap = new ViewMemberInstanceFactoryMetadataMap(new ConcurrentHashMap<String, Object>());
        defaultValidatorIds = new LinkedHashSet<String>();
        behaviorMap = new ViewMemberInstanceFactoryMetadataMap(new ConcurrentHashMap<String, Object>());
