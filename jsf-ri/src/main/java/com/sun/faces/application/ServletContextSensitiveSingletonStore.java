 ...
 */
@WebListener
class ServletContextSensitiveSingletonStore<S> implements ServletContextListener {
    ...
    private static final String KEY_BASE =
            ServletContextSensitiveSingletonStore.class.getName();
    ...
    void removeSingletonOnContextDestroyed() {
        ...
        if (context instanceof ServletContext) {
            ...
            WebappLifecycleListener listener = WebappLifecycleListener.getInstance(sc);
            if (null != listener) {
    ...
    // <editor-fold defaultstate="collapsed" desc="ServletContextListener methods">
