...
public class OutboundParameterTagHandler extends TagHandlerImpl {

    public OutboundParameterTagHandler(TagConfig config) {
        super(config);
    }
    ...
    public void apply(FaceletContext ctx, UIComponent parent) throws IOException {
        ...
        if (null != parameter) {
            List<Parameter> parameters = FacesFlowCallTagHandler.getOutboundParameters(ctx);
