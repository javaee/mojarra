...
/**
 * The CDI producer for ExternalContext.
 */
public class ExternalContextProducer implements Bean<ExternalContext> {

    /**
     * Inner class defining an annotation literal for @Default.
     */
    public class DefaultAnnotationLiteral
            extends AnnotationLiteral<Default> implements Default {
    ...
    public Set<Type> getTypes() {
        return new HashSet<Type>(asList(ExternalContext.class));
    }
