/*
 * $Id: ClientEncryptByDefaultTestCase.java,v 1.1 2007/06/01 18:28:31 edburns Exp $
 */
...
public class ClientEncryptByDefaultTestCase extends AbstractTestCase {
     ...
     */
    public ClientEncryptByDefaultTestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return (new TestSuite(ClientEncryptByDefaultTestCase.class));
    }
