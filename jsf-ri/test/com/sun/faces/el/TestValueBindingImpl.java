/*
 * $Id: TestValueBindingImpl.java,v 1.33.8.3 2007/04/27 21:28:22 ofung Exp $
 */
...
//
    ...
    public void testELGet() {
        ...
        String[] multiHeader = (String[])
            valueBinding.getValue(getFacesContext());
        assertTrue(null != multiHeader);
        assertTrue(multiHeader.length == 1);
        assertTrue("1,2".equals(multiHeader[0]));       
