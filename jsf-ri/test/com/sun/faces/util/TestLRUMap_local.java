...
/* $Id: TestLRUMap_local.java,v 1.1.2.3 2007/04/27 21:28:27 ofung Exp $ */
...
public class TestLRUMap_local extends TestCase {
    ...
    public void testLRUMap() {
        ...
        int count = 3;
        display((String[]) control.clone(), map);
    ...
    private static void display(String[] expected, LRUMap actual) {
        System.out.println("Expected order:");
        List revControl = Arrays.asList(expected);
        Collections.reverse(revControl);
        for (Iterator i = revControl.iterator(); i.hasNext(); ) {        
