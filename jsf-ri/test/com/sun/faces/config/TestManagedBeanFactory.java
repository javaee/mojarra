...
public class TestManagedBeanFactory extends ServletFacesTestCase {
    ...
    public void testEagerManagedBean() throws Exception {
        ...
        // validate the bean is instantiated an in scope
        assertTrue(map.containsKey(beanName));
        ...
        map = getFacesContext().getExternalContext().getSessionMap();
        map.remove(beanName);
        bean = new ManagedBeanInfo(beanName,
                                   beanName,
                                   "session",
        ...
        // validate the bean is not instantiated and in scope
        assertTrue(!map.containsKey(beanName));
