/*
 * $Id: TestExternalContextImpl.java,v 1.13.36.4 2007/04/27 21:28:22 ofung Exp $
 */
 ...
 *
 * @version $Id: TestExternalContextImpl.java,v 1.13.36.4 2007/04/27 21:28:22 ofung Exp $
 */
...
// Tests constructor's ability to create contained objects...
    ...
    */
    ...
    public void testRequestHeaderValuesMap() {
        ...
        String[] iter = (String[]) requestHeaderValuesMap.get("foo");
        String returnValues = iter[0];       

        String value = "one,two,three";
        assertTrue(returnValues.equals(value));
        assertTrue(requestHeaderValuesMap.containsKey("foo"));
        assertTrue(
            requestHeaderValuesMap.containsValue(requestHeaderValuesMap.get("foo")));
