/* 
 * $Id: TestViewHandlerImpl.java,v 1.21.26.1.2.4 2007/04/27 21:28:20 ofung Exp $ 
 */ 
 ...
 *
 * @version $Id: TestViewHandlerImpl.java,v 1.21.26.1.2.4 2007/04/27 21:28:20 ofung Exp $
 */
...
// 
    ...
    public void beginTransient(WebRequest theRequest) {
        theRequest.setURL("localhost:8080", "/test", "/faces", TEST_URI, null);
	theRequest.addParameter("com.sun.faces.VIEW", "_id1:_id2");
    }
   ...
   /* public void testRender2() {
	...
	try {
	    RenderKit curKit = getFacesContext().getRenderKit();
