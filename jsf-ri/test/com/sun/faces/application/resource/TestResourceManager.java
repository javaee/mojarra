...
public class TestResourceManager extends ServletFacesTestCase {
    ...
    public void testWebappNonVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource(null, "duke-nv.gif", getFacesContext());
    ...
    public void testWebappVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource(null, "duke.gif", getFacesContext());
        assertTrue(resource != null);
        assertTrue(resource.getLibraryInfo() == null);
        assertTrue(resource.getHelper() instanceof WebappResourceHelper);
    ...
    public void testWebappNonVersionedLibraryVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("nvLibrary", "duke.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testWebappNonVersionedLibraryNonVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("nvLibrary", "duke-nv.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testWebappVersionedLibraryNonVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("vLibrary", "duke-nv.gif", getFacesContext());
        assertTrue(resource != null);
        ...
        assertTrue(resource.getVersion() == null);
        assertTrue("duke-nv.gif".equals(resource.getName()));
        assertTrue("/resources/vLibrary/2.0/duke-nv.gif".equals(resource.getPath()));
    }

    public void testWebappVersionedLibraryVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("vLibrary", "duke.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testWebappPathResource() throws Exception {
        ResourceInfo resource = manager.findResource("nvLibrary", "images/duke-nv.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testJarNonVersionedResources() throws Exception {
        ResourceInfo resource = manager.findResource(null, "duke-jar-nv.gif", getFacesContext());
        assertTrue(resource != null);
        assertTrue(resource.getLibraryInfo() == null);
    ...
    public void testJarVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource(null, "duke-jar.gif", getFacesContext());
        assertTrue(resource != null);
        assertTrue(resource.getLibraryInfo() == null);
        assertTrue(resource.getHelper() instanceof ClasspathResourceHelper);
        assertTrue("1.1".equals(resource.getVersion()));
    ...
    public void testJarNonVersionedLibraryVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("nvLibrary-jar", "duke.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testJarNonVersionedLibraryNonVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("nvLibrary-jar", "duke-nv.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testJarVersionedLibraryNonVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("vLibrary-jar", "duke-nv.gif", getFacesContext());
        assertTrue(resource != null);
        ...
        assertTrue(resource.getVersion() == null);
        assertTrue("duke-nv.gif".equals(resource.getName()));
        assertTrue("META-INF/resources/vLibrary-jar/2.0/duke-nv.gif".equals(resource.getPath()));
    }

    public void testJarVersionedLibraryVersionedResource() throws Exception {
        ResourceInfo resource = manager.findResource("vLibrary-jar", "duke.gif", getFacesContext());
        assertTrue(resource != null);
    ...
    public void testInvalidLibraryName() throws Exception {
        assertTrue(manager.findResource("noSuchLibrary", "duke.gif", getFacesContext()) == null);
    }

    public void testInvalidResourceName() throws Exception {
        assertTrue(manager.findResource(null, "duke.fig", getFacesContext()) == null);
        assertTrue(manager.findResource("nvLibrary", "duke.fig", getFacesContext()) == null);
    }
