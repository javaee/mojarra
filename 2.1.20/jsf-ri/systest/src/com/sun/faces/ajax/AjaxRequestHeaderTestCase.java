...
public class AjaxRequestHeaderTestCase  extends HtmlUnitFacesTestCase {

    public AjaxRequestHeaderTestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return (new TestSuite(AjaxRequestHeaderTestCase.class));
    }
