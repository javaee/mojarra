...
public class Issue1845TestCase extends HtmlUnitFacesTestCase {

    public Issue1845TestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return (new TestSuite(Issue1845TestCase.class));
    }
    ...
    public void testBasicAppFunctionality() throws Exception {
        ...
        assertTrue(!pageText.contains("Click Me"));
