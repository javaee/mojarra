...
public class Issue1975TestCase extends HtmlUnitFacesTestCase {

    public Issue1975TestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return (new TestSuite(Issue1975TestCase.class));
    }
    ...
    // ------------------------------------------------------------ Test Methods
    // This method ensures that an ajax request with a composite component in
