...
public class JavaTopLevelComponent  extends UINamingContainer {
    ...
    public String getTestResult1() {
        ...
        ValueExpression ve = context.getApplication().getExpressionFactory().createValueExpression(elc, "#{cc.attrs.items1}", Map.class);
        result = ve.getType(elc) == Map.class ? "PASSED" : "FAILED";
