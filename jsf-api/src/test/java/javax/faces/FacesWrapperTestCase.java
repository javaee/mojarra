...
/**
 * <p>A unit test to make sure all classes implementing {@link FacesWrapper} are actually wrapping
 * all public and protected methods of the wrapped class. This should help to keep the wrapper
 * classes in synch with the wrapped classes. </p>
 * 
 * @author dueni
 * @since 2.2.0
 */
public class FacesWrapperTestCase extends TestCase {
    ...
    /**
     * The main goal of this TestSuite: unit test to assert all classes implementing FacesWrapper do
     * wrap all public and protected methods of the wrapped class.
     */
    ...
    /**
     * Returns true it the passed method is contained in the also passed list of methods by also
     * comparing matching parameters.
     * 
     * @param m
     *            the method (from the wrapped class) to compare against.
     * @param wrapperMethods
     *            the list of methods of the wrapper class.
     */
     ...
     *            package name.
     * @param file
     *            current File (directory or file)
     * @throws Exception
     *             might throw ClassNotFoundException from class loading.
     */
    ...
    /**
     * Add classes that are assignable to FacesWrapper class to the wrapperClasses list - and also
     * add classes with a name ending on "Wrapper" but being not assignable to FacesWrapper to the
     * noWrapperClasses list.
     * 
     * @param cl
     *            the ClasslOader used to load the class.
     * @param pkg
     *            the name of the package working in.
     * @param f
     *            the File to analyse.
     * @throws Exception
