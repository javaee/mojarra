 ...
 * @since 2.0
 */
public class AfterNonPDLAddToViewEvent extends AfterAddToViewEvent {
     ...
     * <code>AfterNonPDLAddToViewEvent</code> that indicates the argument
     ...
     */
    public AfterNonPDLAddToViewEvent(UIComponent component) {
