 ...
 * @since 2.0
 */
public class AfterNonRestoreViewAddToViewEvent extends PostAddToViewEvent {
     ...
     * <code>AfterNonRestoreViewAddToViewEvent</code> that indicates the
     ...
     */
    public AfterNonRestoreViewAddToViewEvent(UIComponent component) {
        super(component);
