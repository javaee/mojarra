...
public class FormEvent extends FacesEvent {
     ...
     * @return UIComponent object corresponding to the form control
     *         which was added or removed, or null if the event type
     *         is INIT or EXIT
     */
    public UIComponent getFormControl() {
