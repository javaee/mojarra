...
public abstract class FacesContext {
    ...
    /**
     * <p>Return a {@link PartialContext} instance for the current request.
     * The {@link PartialContext} may be used to determine if the current
     * request indicates a requirement to perform <code>partial processing</code>
     * and/or <code>partial rendering</code>.</p>
     */
    public PartialContext getPartialContext() {
        if (defaultFacesContext != null) {
            return defaultFacesContext.getPartialContext();
        }
        throw new UnsupportedOperationException();
