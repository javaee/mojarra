/*
 * $Id: PartialContext.java,v 1.76.2.2 2008/04/09 08:59:05 edburns Exp $
 */
 ...
 * processing and partial response rendering.</p> 
 *
 * <p>The {@link PartialContext} instance is used to determine if
...
public abstract class PartialContext {
    ...
    private PartialContext defaultPartialContext;
     ...
     * <code>PartialContext</code> instance.  This <code>Map</code> is 
     ...
     * request.  Otherwise, return <code>false</code>.  If 
     * <code>javax.faces.partial</code> is present with the value
     * <code>true</code>, then it is expected that a parameter
     * <code>javax.faces.partial.execute</code> is also present
     * whose value is a <code>List</code> of client identifiers.</p> 
     *
     * @throws IllegalStateException if this method is called after
     *  this instance has been released
     *
     ...
     * resources associated with this <code>PartialContext</code>
     * instance.</p>
     *
