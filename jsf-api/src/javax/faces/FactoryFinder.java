/*
 * $Id: FactoryFinder.java,v 1.25.40.3 2007/04/27 21:26:44 ofung Exp $
 */
...
public final class FactoryFinder {
	...
	validateFactoryName(factoryName);
	    ...
	    // find it.
            ...
            if (null == factory) {
                String message = "Application was not properly initialized at startup, could not find Factory: {0}";
                message = MessageFormat.format(message, new Object[] {factoryName});
