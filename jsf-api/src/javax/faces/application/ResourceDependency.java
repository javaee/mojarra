 ...
 * the class level will automatically have a resource dependency added
 * so that the named resource will be present in user agent's view of
 ...
 * 	<ol>
	  ...
	  the values of the <em>name</em>, <em>library</em>, and
	  <em>target</em> attributes.</p></li>
