/*
 * $Id: UIComponentBase.java,v 1.101.26.7 2007/04/27 21:26:46 ofung Exp $
 */
...
public abstract class UIComponentBase extends UIComponent {
    ...
    protected Renderer getRenderer(FacesContext context) {
        ...
        String rendererType = getRendererType();
        if (rendererType != null) {            
            return (context.getRenderKit().getRenderer(getFamily(), 
                                                       rendererType));
        } else {
            return (null);
        }
    ...
    // required by UIComponent.getAttributes()
    // Older versions used inheritence to provide the
