/*
 * $Id: UIComponent.java,v 1.150.4.4 2008/04/17 21:17:00 rlubke Exp $
 */
...
* </code></pre>
    ...
    List<String> getAttributesThatAreSet(boolean create) {
        // Class.getPackage() returns null for Groovy based-classes.
        Package pkg = this.getClass().getPackage();
        if (pkg != null) {
            String pkgName = this.getClass().getPackage().getName();
            if (create
                && Arrays.binarySearch(OPTIMIZED_PACKAGES, pkgName) >= 0) {
