/*
 * $Id: ConfigParser.java,v 1.1 2003/09/25 22:22:04 eburns Exp $
 */
...
class ConfigParser extends Object {
    ...
    protected void configureRules() {
        ...
        digester.addObjectCreate(prefix, 
				 "javax.faces.generate.ConfigRenderKit");
	prefix = prefix + "/renderer";
	
        digester.addObjectCreate(prefix, 
				 "javax.faces.generate.ConfigRenderer");
	...
	digester.addObjectCreate(prefix,
				 "javax.faces.generate.ConfigAttribute");
    ...
    void parseConfig(InputStream input) throws Exception {        
	digester.clear();
