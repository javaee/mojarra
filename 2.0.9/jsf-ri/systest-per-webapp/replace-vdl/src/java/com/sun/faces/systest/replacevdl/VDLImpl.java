...
package com.sun.faces.systest.replacevdl;
...
public class VDLImpl extends ViewDeclarationLanguage implements FacesWrapper<ViewDeclarationLanguage> {

    private ViewDeclarationLanguage toWrap;

    public VDLImpl(ViewDeclarationLanguage toWrap) {
        this.toWrap = toWrap;
    }
    ...
    public void buildView(FacesContext fc, UIViewRoot uivr) throws IOException {
        ...
        if (!params.containsKey("skipBuildView")) {
            this.logMethodInvocation();
            this.getWrapped().buildView(fc, uivr);
        }
    }

    // <editor-fold defaultstate="collapsed" desc="Superclass overrides">
