...
public class DecoratedVDLFactory extends ViewDeclarationLanguageFactory {
    ...
    private Map<String,VDLImpl> vdlImpls;

    public DecoratedVDLFactory(ViewDeclarationLanguageFactory toWrap) {
        this.toWrap = toWrap;
        vdlImpls = new ConcurrentHashMap<String, VDLImpl>();
    }
    ...
    public ViewDeclarationLanguage getViewDeclarationLanguage(String string) {
        ...
        if (null == (result = vdlImpls.get(string))) {
            result = new VDLImpl(getWrapped().getViewDeclarationLanguage(string));
