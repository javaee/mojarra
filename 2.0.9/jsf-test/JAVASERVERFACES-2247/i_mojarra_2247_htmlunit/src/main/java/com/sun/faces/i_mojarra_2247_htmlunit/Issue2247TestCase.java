...
package com.sun.faces.i_mojarra_2247_htmlunit;
...
public class Issue2247TestCase extends HtmlUnitFacesTestCase {

    public Issue2247TestCase(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return (new TestSuite(Issue2247TestCase.class));
    }
    ...
    public void testNoELEvaluation() throws Exception {
        ...
        HtmlPage page = getPage("/faces/i_mojarra_2247_war.xhtml");
