  ...
  extends FaceletCache
{
  ...
  {
    if (null == url) throw new NullPointerException("The supplied url is null");
  ...
  /**
   * Implementation of ClientObjectFactory that MDS will callback.
   * This implementation delegates to appropriate Facelet instance factory.
   */
  ...
  // defined in oracle.mds.internal.MDSConstants.MDS_PROTOCOL_FACELETS, temporarily declare it here until we get it in 
  //    API package from MDS team.
