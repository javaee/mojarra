...
public class ReplaceVDLFactory extends ViewDeclarationLanguageFactory {
    ...
    public ReplaceVDLFactory(ViewDeclarationLanguageFactory toWrap) {
        this.toWrap = toWrap;
        vdlImpls = new ConcurrentHashMap<String, ReplaceVDLImpl>();
    }
    ...
    public ViewDeclarationLanguage getViewDeclarationLanguage(String string) {
        ReplaceVDLImpl result = null;

        if (null == (result = vdlImpls.get(string))) {
            result = new ReplaceVDLImpl(getWrapped().getViewDeclarationLanguage(string));
