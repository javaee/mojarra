 ...
 * holder.
 */
package com.sun.faces.test.agnostic.component.custom;
...
@ResourceDependencies({
    @ResourceDependency(library = "rendererAnnotation", name = "rendererAnnotation.js")})
public class RendererAnnotationRenderer extends Renderer {
