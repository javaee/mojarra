...
public class Issue20809236IT {
    ...
    @JsfTest(JsfVersion.JSF_2_1_23)
    @Test
    public void testFakeStatelessViewState() throws Exception {
        webClient.getOptions().setThrowExceptionOnFailingStatusCode(false);
        HtmlPage page = webClient.getPage(webUrl + "faces/viewNotTransient.xhtml");
        ...
        page = webClient.getPage(webUrl + "faces/viewNotTransient.xhtml");
