...
public class InvalidatedBean {
    ...
    public void destroy() {
        /*
         * For the purpose of the test we can actually ask for the current instance
         * of the FacesContext, because we trigger invalidating of the session through
         * a JSF page, however in most cases this will NOT be true. So this means that
         * the @PreDestroy annotated method should not try to use 
