 ...
 */
package com.sun.faces.test.javaee7.facelets.core;
...
@FacesConverter(value = "com.sun.faces.test.javaee7.facelets.core.ConverterInjectEjbConverter")
public class ConverterInjectEjbConverter implements Converter {

    @EJB
    private ConverterInjectEjb ejb;
    
    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        return ejb.getAsObject(value);
    }
